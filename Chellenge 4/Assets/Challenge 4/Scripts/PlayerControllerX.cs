...
internal struct NewStruct
{
    ...
    public NewStruct(float item1, float item2)
    {
        Item1 = item1;
        Item2 = item2;
    }
    ...
    public static implicit operator (float, float)(NewStruct value)
    {
        return (value.Item1, value.Item2);
    }

    public static implicit operator NewStruct((float, float) value)
    {
